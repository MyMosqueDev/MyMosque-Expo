...
export default function Settings() {
    ...
    const debouncedSaveSettings = useCallback(async (newSettings: Settings) => {
    ...
    const updateSetting = useCallback((key: keyof Settings, value: any) => {
        setSettings(prevSettings => {
            ...
            if (key === 'events' || key === 'announcements' || key === 'development') {
    ...
    const toggleDevMode = () => {
        if (settings.development.enabled) {
            ...
            Alert.alert("Development Mode Disabled", "Development mode has been turned off.");
        } else {
    ...
    return (
        <ImageBackground 
            ...
            resizeMode="cover"
        >
            <Header name={mosqueInfo?.name || ""} type="settings" title={"Settings"} />
                                ...
                                >
                                    <View className="w-full bg-white/70 rounded-2xl p-4 shadow-md border border-white/30">
                                        <View className="flex-row items-center justify-between">
                                            <View className="flex-row items-center flex-1">
                                                <View className="w-10 h-10 bg-white/50 rounded-full items-center justify-center mr-3">
                                                    <Ionicons name="notifications" size={20} color="#5B4B94" />
                                                </View>
                                            ...
                                            <View className="flex-row items-center">
                                                ...
                                                <Ionicons name="chevron-forward" size={20} color="#5B4B94" />
                                            </View>
                                        </View>
                                    </View>
                                </TouchableOpacity>
                        ...
                        >
                            ...
                            >
                                <View className="w-full bg-white/70 rounded-2xl p-4 shadow-md border border-white/30">
                                    ...
                                    MyMosque is your go-to app for staying connected with your local mosque.
                                    Check prayer times, keep up with announcements, and never miss an event, all in one place.
                                    </Text>
                                </View>
                            </MotiView>
                            ...
                            >
                                <View className="w-full bg-white/70 rounded-2xl p-4 shadow-md border border-white/30">
                                    ...
                                    <TouchableOpacity onPress={() => Linking.openURL(`mailto:ali@mymosque.app`)} className="flex-row items-center mb-3">
                                        <Ionicons name="mail" size={16} color="#88AE79" style={{ marginRight: 8 }} />
                                        <Text className="text-sm font-lato text-[#88AE79]">Contact Support</Text>
                                    </TouchableOpacity>
                                    
                                    <TouchableOpacity onPress={() => Linking.openURL('https://github.com/MyMosqueDev/MyMosque-Expo')} className="flex-row items-center">
                                        <Ionicons name="code" size={16} color="#88AE79" style={{ marginRight: 8 }} />
                                        <Text className="text-sm font-lato text-[#88AE79]">Source Code</Text>
                                    </TouchableOpacity>
                                </View>
                            </MotiView>
                        </MotiView>
                                    ...
                                    {showDevInput && (
                                        ...
                                        >
                                            <View className="flex-row items-center gap-3">
                                                ...
                                                >
                                                    <Text className="text-white font-lato-bold text-sm">Submit</Text>
                                                </TouchableOpacity>
                                            </View>
                                        </MotiView>
                                    )}
