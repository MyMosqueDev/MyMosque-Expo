  ...
  return (
    ...
    >
      <View className="w-full flex-row justify-between px-2">
        <Text className="text-[#4A4A4A] text-2xl font-lato-bold">
          {prayerTimes.nextPrayer.name.charAt(0).toUpperCase() +
            prayerTimes.nextPrayer.name.slice(1)}
        </Text>
        <MotiView
        ...
        >
          <Text className="text-[#4A4A4A] text-xl font-lato-bold pt-1">
            {convertMinutesToTime(prayerTimes.nextPrayer.minutesToNextPrayer)}
          </Text>
        </MotiView>
      </View>
